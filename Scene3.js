class Scene3 extends Phaser.Scene {
    ...
    create(){
      ...
      resetround()
        ...
        this.background = this.add.image(500, 370, "background2");
        ...
        this.plat.create(497, 62, 'p1')
        this.plat.create(497, 680, 'p1')

        this.plat.create(119, 376, 'p2')
        this.plat.create(888, 376, 'p2')

        this.plats = this.physics.add.staticGroup()
        this.plats.create(376, 351, 'p2').setCircle(71).setVisible()
        this.plats.create(516, 350, 'p2').setCircle(71).setVisible()
        this.plats.create(516, 498, 'p2').setCircle(72).setVisible()
        this.plats.create(367, 495, 'p2').setCircle(72).setVisible()
