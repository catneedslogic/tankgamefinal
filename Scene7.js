class Scene7 extends Phaser.Scene {
    ...
    create(){
      ...
      resetround()
        ...
        this.background = this.add.image(500, 370, "background6");
        ...
        this.plat.create(800, 580, 'p5')
        this.plat.create(200, 580, 'p5')
        this.plat.create(800, 160, 'p5')
        this.plat.create(200, 160, 'p5')
        ...
        this.plats = this.physics.add.image(500, 370, "socball")
        ...
        let deathlyhollowthesenutzlmao = () => {
