class Scene5 extends Phaser.Scene {
    ...
    create(){
      ...
      resetround()
        ...
        this.background = this.add.image(500, 370, "background4");
        // this.background.setScale(2)

        // this.p1 = this.physics.add.sprite(900, 600, bluetanks[randint(16)]);
        this.p1 = this.physics.add.sprite(915, 670, "bluetank");
        mktank(this.p1)
        this.p2 = this.physics.add.sprite(80, 75, "redtank");
        mktank(this.p2)
        ...
        this.plat.create(50, 135, 'p3')
        this.plat.create(945, 610, 'p3')

        this.plat.create(500, 450, 'p3')
        this.plat.create(500, 250, 'p3')
        this.plat.create(700, 350, 'p4')
        this.plat.create(300, 350, 'p4')

        this.plat.create(135, 350, 'p3')
        this.plat.create(865, 350, 'p3')

        this.plat.create(500, 0, 'p3').setVisible().setBodySize(1000, 95, true)
        this.plat.create(0, 400, 'p3').setVisible().setBodySize(100, 1000, true)
        this.plat.create(500, 743, 'p3').setVisible().setBodySize(1000, 95, true)
        this.plat.create(1000, 400, 'p3').setVisible().setBodySize(100, 1000, true)
